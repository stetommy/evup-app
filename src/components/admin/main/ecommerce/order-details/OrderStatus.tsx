    ...
    <Card flexDirection='column' w='100%' pt='30px' pb='20px' {...rest}>
      ...
      <Flex position='relative' direction='column'>
        <Flex
          ...
          h='100%'
          w='2px'
          bg={`url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' stroke='${lineColor}' strokeWidth='4' stroke-dasharray='6%2c 14' stroke-dashoffset='0' stroke-linecap='square'/%3e%3c/svg%3e")`}
          zIndex={1}
        />
        <OrderStep
          mb='80px'
