...
// Custom components
import { MdChevronRight, MdChevronLeft, MdSettings } from 'react-icons/md';
...
import { useAllCoursesQuery } from 'features/course/courseApi';
...
export default function SearchTableOrders(props: { tableData: RowObj[] }) {
  ...
  const handleEdit = async (info): Promise<void> => {
    router.push('/user/instructor/edit-course');
