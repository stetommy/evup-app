    ...
    <Card p='30px' {...rest}>
      <Box>
        <Flex
          ...
          justify='center'
          bg={bg}
          bgImage={`url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' rx='13' ry='13' stroke='%${border}' strokeWidth='4' stroke-dasharray='6%2c 14' stroke-dashoffset='5' stroke-linecap='square'/%3e%3c/svg%3e")`}
          borderRadius='16px'
          w='100%'
          cursor='pointer'
          mb='12px'
